...
const advancedTrackingUtils = {
  ...
  trackFacebookPurchase: async (orderData: any, clientEventId: string): Promise<void> => {
    const purchaseData = {
      ...
      content_ids: ['smartwatch-neznisitelny'],
      content_name: 'Smartwatch Neznisitelný',
      value: 1249.00,
      currency: 'CZK',
      num_items: 1
    };
    ...
    if (typeof window !== 'undefined' && window.gtag) {
      try {
        ...
        window.gtag('event', 'purchase', {
          ...
          currency: 'CZK',
          items: [{
            item_id: 'smartwatch-neznisitelny',
            item_name: 'Smartwatch Neznisitelný',
...
const ThankYouPage = () => {
  ...
  const benefits = [
    {
      ...
      description: "Spokojenost nebo 100% vrácení peněz"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Sledovatelná Zásilka",
      description: "Číslo pro sledování obdržíte SMS zprávou"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Zákaznická Podpora",
      description: "Specializovaná pomoc pro všechny vaše potřeby"
    }
  ];
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      description: "Váš produkt bude pečlivě připraven a zabalen v našem skladu",
      time: "24 hodin"
    },
    {
      step: "3",
      title: "Expresní Zásilka",
      description: "Bezplatné doručení expresním kurýrem s číslem pro sledování v balíku",
      time: "24-48 hodin"
    }
  ];
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Děkujeme za výběr našich produktů
          </p>
          {orderData?.orderId && (
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 mb-6 border-2 border-green-200">
              ...
              <div className="bg-white rounded-lg p-4 border border-green-300">
                <p className="text-gray-700 text-center">
                  ...
                  Operátor ověří vaše údaje a potvrdí zásilku pro zajištění dokonalého doručení.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-yellow-700">
                ...
                <li>• <strong>Žádné platby nyní</strong> - Platíte při převzetí</li>
                <li>• <strong>Bezplatné doručení</strong> - Bez dalších poplatků</li>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Připojili Se K Více Než 10.000 Spokojených Zákazníků
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Udělali jste správnou volbu kvality a spolehlivosti našich produktů.
            </p>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg p-4 border-2 border-green-200">
                <div className="text-2xl font-bold text-green-600">98%</div>
                <p className="text-green-700 text-sm">Spokojených zákazníků</p>
              </div>
