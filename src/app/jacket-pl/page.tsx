            ...
            <div className="bg-white rounded-lg p-6 md:p-8 max-w-md w-full relative my-4 md:my-8 min-h-0">
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="space-y-4 border-t border-gray-200 pt-6">
                  <h3 className="text-lg font-semibold text-gray-800 text-center">Wybierz Model i Rozmiar</h3>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        type="button"
                        onClick={() => handleFormChange('modello', 'Męski')}
                        className={`relative p-4 rounded-lg border-2 transition-all duration-200 ${formData.modello === 'Męski'
                      ...
                      >
                        <div className="flex flex-col items-center">
                          ...
                          <span className={`font-medium ${formData.modello === 'Męski' ? 'text-green-700' : 'text-gray-700'
                            }`}>
                            Męski
                          </span>
                        </div>
                        {formData.modello === 'Męski' && (
                      ...
                      <button
                        type="button"
                        onClick={() => handleFormChange('modello', 'Damski')}
                        className={`relative p-4 rounded-lg border-2 transition-all duration-200 ${formData.modello === 'Damski'
                          ? 'border-green-500 bg-green-50 shadow-md'
                          : 'border-gray-300 bg-white hover:border-gray-400'
                          }`}
                      >
                        <div className="flex flex-col items-center">
                          <div className="text-2xl mb-2">👩</div>
                          <span className={`font-medium ${formData.modello === 'Damski' ? 'text-green-700' : 'text-gray-700'
                            }`}>
                            Damski
                          </span>
                        </div>
                        {formData.modello === 'Damski' && (
                          <div className="absolute top-2 right-2 w-5 h-5 bg-green-500 rounded-full flex items-center justify-center">
                            <Check className="w-3 h-3 text-white" />
                          </div>
                        )}
                    ...
                    {formErrors.modello && (
                      <p className="mt-2 text-sm text-red-600">{formErrors.modello}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2 md:gap-3">
                      {['S', 'M', 'L', 'XL', 'XXL', '3XL'].map((size) => (
                        <button
                          key={size}
                          type="button"
                          onClick={() => handleFormChange('taglia', size)}
                          className={`relative p-3 md:p-4 rounded-lg border-2 transition-all duration-200 ${formData.taglia === size
                            ? 'border-green-500 bg-green-50 shadow-md'
                            : 'border-gray-300 bg-white hover:border-gray-400'
                            }`}
                        >
                          <div className="text-center">
                            <span className={`font-bold text-lg ${formData.taglia === size ? 'text-green-700' : 'text-gray-700'
                              }`}>
                              {size}
                            </span>
                          </div>
                    ...
                    {formErrors.taglia && (
                      <p className="mt-2 text-sm text-red-600">{formErrors.taglia}</p>
                    )}
                  </div>
              ...
              {/* Podsumowanie Wyboru */}
              {(formData.modello || formData.taglia) && (
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 mb-4">
                  <h4 className="font-semibold text-green-800 mb-2 text-center">Twój wybór:</h4>
                  <div className="flex flex-wrap justify-center gap-3">
                    {formData.modello && (
                      <div className="flex items-center gap-2 bg-white px-3 py-1 rounded-full border border-green-300">
                        <span className="text-sm">{formData.modello === 'Męski' ? '👨' : '👩'}</span>
                        <span className="text-sm font-medium text-green-700">{formData.modello}</span>
                      </div>
                    )}
                    {formData.taglia && (
                      <div className="flex items-center gap-2 bg-white px-3 py-1 rounded-full border border-green-300">
                        <span className="text-sm">📏</span>
                        <span className="text-sm font-medium text-green-700">Rozmiar {formData.taglia}</span>
                      </div>
                    )}
                  </div>
                </div>
