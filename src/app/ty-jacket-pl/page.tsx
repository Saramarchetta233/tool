...
const ThankYouPage = () => {
  ...
  const benefits = [
    {
      ...
      title: "Ochraniacze CE Level 1 w Zestawie",
      description: "Certyfikowane ochraniacze bezpieczeństwa w komplecie"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Membrana Wodoodporna + Oddychająca",
      description: "Zaawansowana technologia ochrony przed deszczem"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Wypinana Podszewka Termiczna",
      description: "4-sezonowa uniwersalność dla każdej pogody"
    }
  ];
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      description: "Twoja kurtka motocyklowa zostanie starannie przygotowana i zapakowana w naszym magazynie",
      time: "24 godziny"
    },
    {
      step: "3",
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Dziękujemy za wybór RoadShield™ 4-Seasons
          </p>
          {orderData?.orderId && (
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-yellow-700">
                ...
                <li>• <strong>Gwarancja 30 dni</strong> - Zadowoleni lub zwrot pieniędzy</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Dołączyłeś do Ponad 8.000 Zadowolonych Motocyklistów
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Dokonałeś właściwego wyboru bezpieczeństwa i komfortu jazdy z RoadShield™ 4-Seasons.
            </p>
