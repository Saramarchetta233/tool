...
const ThankYouPage = () => {
  ...
  useEffect(() => {
    ...
    const formatData = (data: Date): string => {
      ...
      const mesi = ['led', 'úno', 'bře', 'dub', 'kvě', 'čer', 'čer', 'srp', 'zář', 'říj', 'lis', 'pro'];
  ...
  const benefits = [
    {
      ...
      title: "Chrániče CE Level 1 v sadě",
      description: "Certifikované bezpečnostní chrániče v kompletu"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Voděodolná + prodyšná membrána",
      description: "Pokročilá technologie ochrany před deštěm"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Vyjímatelná termální podšívka",
      description: "4-sezónní univerzálnost pro každé počasí"
    }
  ];
  ...
  const nextSteps = [
    {
      ...
      description: "Náš operátor se s vámi spojí v nejbližších hodinách, aby potvrdil údaje objednávky",
      time: "Brzy"
    },
    {
      step: "2",
      title: "Příprava objednávky",
      description: "Vaše motocyklová bunda bude pečlivě připravena a zabalena v našem skladu",
      time: "24 hodin"
    },
    {
      step: "3",
      title: "Expresní doručení",
      description: "Bezplatné expresní doručení kurýrem se sledovacím číslem v sadě",
      time: "24-48 hodin"
    }
  ];
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Děkujeme za výběr RoadShield™ 4-Seasons
          </p>
          {orderData?.orderId && (
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 mb-6 border-2 border-blue-200">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <div className="text-left">
                  <h3 className="text-xl font-bold text-blue-700">
                    Přichází ověřovací hovor
                  </h3>
                  <p className="text-blue-600">
                    Náš operátor se s vámi spojí v nejbližších hodinách
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-blue-300">
                <p className="text-gray-700 text-center">
                  <strong className="text-blue-600">📞 Mějte telefon po ruce!</strong><br />
                  Operátor ověří vaše údaje a potvrdí expedici, aby zaručil ideální doručení.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-blue-200">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">🚚</div>
                <div className="font-medium text-gray-800">Expedováno</div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-yellow-700">
                <li>• <strong>Mějte telefon zapnutý</strong> - Zavoláme vám v nejbližších hodinách</li>
                <li>• <strong>Ověřte své údaje</strong> - Operátor potvrdí jméno, telefon a adresu</li>
                <li>• <strong>Žádná platba nyní</strong> - Zaplatíte při převzetí</li>
                <li>• <strong>Bezplatné doručení</strong> - Bez dodatečných nákladů</li>
                <li>• <strong>Záruka 30 dnů</strong> - Spokojenost nebo vrácení peněz</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Připojili jste se k více než 8.000 spokojeným motocyklistům
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Udělali jste správnou volbu bezpečnosti a komfortu jízdy s RoadShield™ 4-Seasons.
            </p>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg p-4 border-2 border-blue-200">
                <div className="text-2xl font-bold text-blue-600">98%</div>
                <p className="text-blue-700 text-sm">Spokojených zákazníků</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-100 to-indigo-100 rounded-lg p-4 border-2 border-purple-200">
                ...
                <p className="text-purple-700 text-sm">Dodávek včas</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-indigo-100 to-blue-100 rounded-lg p-4 border-2 border-indigo-200">
                ...
                <p className="text-indigo-700 text-sm">Doporučilo by známému</p>
              </div>
            </div>
          </div>
        </div>
