...
const advancedTrackingUtils = {
  ...
  trackFacebookPurchase: async (orderData: any, clientEventId: string): Promise<void> => {
    const purchaseData = {
      ...
      content_ids: ['pocketcam-4k-pro-camera'],
      content_name: 'PocketCam 4K Pro™ – Kamera kieszonkowa z obiektywem 270° i mikrofonem',
      value: 299.00,
      currency: 'PLN',
      num_items: 1
    };
    ...
    if (typeof window !== 'undefined' && window.gtag) {
      try {
        ...
        window.gtag('event', 'purchase', {
          ...
          currency: 'PLN',
          items: [{
            item_id: 'pocketcam-4k-pro-camera',
            item_name: 'PocketCam 4K Pro™ – Kamera kieszonkowa z obiektywem 270° i mikrofonem',
...
const ThankYouPage = () => {
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      description: "Twoja kamera zostanie starannie przygotowana i zapakowana w naszym magazynie",
      time: "24 godziny"
    },
    {
      step: "3",
      ...
      <div className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Dziękujemy za wybór PocketCam 4K Pro™
          </p>
          {orderData?.orderId && (
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg mb-6">
              Dokonałeś właściwego wyboru nowoczesnej kamery PocketCam 4K Pro™ z obiektywem 270°.
            </p>
